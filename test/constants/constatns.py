...
test_jp = 'test.木'
test_csv = 'mythic.csv'
test_txt = 'test/text_files/some_test.txt'

test_txt_extension = 'test.txt'
test_csv_extension = 'test.csv'
test_doc_extension = 'test.doc'

test_csv_file_name = 'test/text_files/some_test.csv'
test_txt_file_name = 'test/text_files/some_test.txt'
test_txt_file_name_for_read = 'test/text_files/file_for_read.txt'
test_doc_file_name = 'test/text_files/some_test.doc'
test_txt_file_empty = 'test/text_files/test_empty.txt'
...
path_of_get_mode = 'core.menu.MenuGetMode.run_menu'
...
test_modes_lists = {
       'test1': ['1', 'test_1', 'test test'],
       'test2': ['2', '2_test', 'horosho']
}
